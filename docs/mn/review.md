...
5. **Tuple-based result**
 - `match()` нь тогтмол 3-tuple `[callable, params, middleware]` буцаана
 - Хамгийн хурдан positional access, type-safe

6. **Per-route middleware**
 - `Route::middleware([...])` chain-р оноох
 - Append semantics - олон удаа дуудаж нэмэх боломжтой
...
2. **Class structure**
 ...
 - `Router` ба `RouterInterface` сайн тусгаарлагдсан
...
1. **Test coverage**
 - Нийт 71 тест, 161 assertion (PHPUnit 10.5)
 - Бүх public API хамрагдсан (`match`, `generate`, `pattern`, `getRoutes`, `__call`, `Route::name`, `Route::middleware`, `registerName`, `registerMiddleware`)
 ...
 - HEAD -> GET авто fallback (RFC 7231 sec. 4.3.2) 4 тестээр хамрагдсан
 - Per-route middleware 8 тестээр хамрагдсан (registration, chain, isolation, HEAD inheritance, closure, public API)
 - 3rd-party adapter pattern 4 тестээр хамрагдсан (FastRoute style, Symfony style, hybrid, destructuring)

2. **Test structure**
 - `RouterTest` нь codesaur Router-ийн бүх public API-г бүрэн coverage хийсэн
 - `AdapterPatternTest` нь interface-ийн adapter-compatibility-ийг шалгасан
...
1. **Route groups (prefix-тэй бүлэглэх)**
 - Олон route-уудыг нэг URL prefix-ийн доор бүлэглэх (жишээ нь `/api/v1/...`)
 - Тэмдэглэл: Нийтлэг middleware-ийг хуваалцах хэрэгцээг inheritance pattern (README-д үзүүлсэн) одоогоор хангаж байна. Prefix bundling нэмэлт үнэ цэн авчирна
