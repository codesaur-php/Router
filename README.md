...
- 📚 **[API.md](API.md)** ([🇬🇧 English](API.EN.md)) - Бүх public API-ийн дэлгэрэнгүй тайлбар, method-ууд, parameter-ууд, exception-ууд (PHPDoc-уудаас Cursor AI ашиглан автоматаар үүсгэсэн)
- 🔍 **[REVIEW.md](REVIEW.md)** ([🇬🇧 English](REVIEW.EN.md)) - Код шалгалтын тайлан, давуу талууд, сайжруулах боломжууд  (Cursor AI ашиглан үүсгэсэн)
- 📋 **[CHANGELOG.md](CHANGELOG.md)** ([🇬🇧 English](CHANGELOG.EN.md)) - Пакетийн бүх хувилбаруудын өөрчлөлтийн түүх
